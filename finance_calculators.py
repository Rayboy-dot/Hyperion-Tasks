...
if choice == "investment":
    ...
    if interest == "simple":
        ...
        total_amount2 = amount_money * math.pow((1+interest_rate/100), duration) 
 ...
 # When user chooses 'bond'.   
    ...
    bond_repay = round(((bond_rate*0.01)/12*house_value)/(1 - math.pow(1 + ((bond_rate*0.01)/12),-repay_time)),2)
